 ...
 * @access 		public
 */
class VodFormSelectCategory extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function VodFormSelectCategory($caption, $name, $value = null, $size = 1, $multiple = false, $ownid=0)
    {
	...
	function GetCategory($ownid){
		...
		$categories = $category_handler->getObjects(new Criteria('parent', 0), true);
	...
	function TreeMenu($langs_array, $categories, $level, $ownid) {
		...
		foreach($categories as $catid => $category) {
			if ($catid!=$ownid) {
				...
				if ($categoriesb = $category_handler->getObjects(new Criteria('parent', $catid), true)){
