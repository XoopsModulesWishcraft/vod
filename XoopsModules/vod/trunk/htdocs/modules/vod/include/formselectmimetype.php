 ...
 * @access 		public
 */
class VodFormSelectMimetype extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function VodFormSelectMimetype($caption, $name, $value = null, $size = 1, $multiple = false, $none = true)
    {
        ...
        $videos_handler = xoops_getmodulehandler('mimetypes', 'vod');
		foreach($videos_handler->getObjects(NULL, true) as $mid => $obj)
			$this->addOption($mid, $obj->getVar('name').' ('.$mid.')');
    }
