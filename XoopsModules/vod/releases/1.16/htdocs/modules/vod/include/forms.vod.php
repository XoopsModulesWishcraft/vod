<?php
	...
	function vod_videos_get_form($object, $as_array=false) {
		...
		$ele['cid'] = new VodFormSelectCategory(($as_array==false?_FRM_VOD_FORM_VOD_CATEGORY:''), $id.'[cid]', $object->getVar('cid'));
		...
		if (strlen($object->getVar('poster'))>0&&file_exists($GLOBALS['xoops']->path($object->getVar('path').$object->getVar('poster')))) {
			$ele['poster_preview'] = new XoopsFormLabel(($as_array==false?_FRM_VOD_FORM_VOD_POSTER:''), '<img src="'.XOOPS_URL.'/'.$object->getVar('path').$object->getVar('poster').'" width="340px" />' );
		...
		if (strlen($object->getVar('avata'))>0&&file_exists($GLOBALS['xoops']->path($object->getVar('path').$object->getVar('avata')))) {
			$ele['avata_preview'] = new XoopsFormLabel(($as_array==false?_FRM_VOD_FORM_VOD_AVATA:''), '<img src="'.XOOPS_URL.'/'.$object->getVar('path').$object->getVar('avata').'" width="340px" />' );
		...
		if ($GLOBALS['vodModuleConfig']['matrixstream']==false) {
			...
			$ele['currency'] = new VodFormSelectMimetype(($as_array==false?_FRM_VOD_FORM_VOD_CURRENCY:''), $id.'[currency]', $object->getVar('currency'));
	...
	function vod_category_get_form($object, $as_array=false) {
		...
		if (strlen($object->getVar('avata'))>0&&file_exists($GLOBALS['xoops']->path($object->getVar('path').$object->getVar('avata')))) {
			$ele['avata_preview'] = new XoopsFormLabel(($as_array==false?_FRM_VOD_FORM_CATEGORY_AVATA:''), '<img src="'.XOOPS_URL.'/'.$object->getVar('path').$object->getVar('avata').'" width="340px" />' );
