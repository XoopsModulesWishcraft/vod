 ...
 * @access 		public
 */
class VodFormSelectSupport extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function VodFormSelectSupport($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
		...
		foreach(array('_MI_VOD_FLASH', '_MI_VOD_HTML5', '_MI_VOD_HTTP', '_MI_VOD_IOS', '_MI_VOD_RTMP', '_MI_VOD_RTSP', '_MI_VOD_SILVERLIGHT', '_MI_VOD_OTHER') as $enum)
			$this->addOption($enum, (defined($enum)?constant($enum):$enum));
    }
