<?php
	...
	define('_AM_VOD_TH_CURRENCY', 'Currency');
	...
	define('_AM_VOD_TH_DISCOUNTS_AUD', 'Discounts (AUD)');
	...
	define('_AM_VOD_TH_CURRENCY_ID', 'Currency ID');
	define('_AM_VOD_TH_MODE', 'Mode');
	define('_AM_VOD_TH_CATNO', 'Cataloge No.');
	define('_AM_VOD_TH_CRTID', 'Item ID');
	define('_AM_VOD_TH_ADDED', 'Item added');
	define('_AM_VOD_TH_NOTIFIED', 'Notification Sent');
	define('_AM_VOD_TH_CLAIMED', 'First Viewed');
	define('_AM_VOD_TH_EXPIRES', 'Purchase expires');
	...
	define('_AM_VOD_SESSIONS_VIEWCART', 'View Cart');
	define('_AM_VOD_SESSIONS_CANCEL', 'Cancel Cart');
	...
	define('_AM_VOD_MSG_CURRENCY_SAVEDOKEY', 'Currency Saved Fine!');
	define('_AM_VOD_MSG_CURRENCY_FAILEDTOSAVE', 'Failed to save Currency!');
	define('_AM_VOD_MSG_CURRENCY_FAILEDTODELETE', 'Failed to Delete Currency!');
	define('_AM_VOD_MSG_CURRENCY_DELETED', 'Currency Deleted Successfully!');
