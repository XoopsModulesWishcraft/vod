 ...
 * @access 		public
 */
class VodFormSelectVideos extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function VodFormSelectVideos($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
		...
		foreach($videos_handler->getObjects(NULL, true) as $vid => $obj)
			$this->addOption($vid, $obj->getVar('name').' ('.$vid.')');
    }
