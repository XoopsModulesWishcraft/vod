<?php
	...
	if (is_object($GLOBALS['vodModule'])) {
		...
		define('_MI_VOD_LINK_ADMENU5', 'admin/index.php?op=currency&fct=list');		
	...
	// Version 1.20
	// Preferences
	define('_MI_VOD_CART', 'Use shopping cart?');
	define('_MI_VOD_CART_DESC', 'If you are not using the shopping cart, every single video must be paid for upfront without checkout!');
	define('_MI_VOD_FREE_TOPIC', 'Free Items Topic in News');
	define('_MI_VOD_FREE_TOPIC_DESC', 'When you publish a news article that is a free item this is the topic it lands in.');
	define('_MI_VOD_COST_TOPIC', 'Cost Items Topic in News');
	define('_MI_VOD_COST_TOPIC_DESC', 'When you publish a news article that has a costage associated with the item this is the topic it lands in.');
?>